...
export default class MapboxStyleSwitcherControl implements mapboxgl.IControl {
  private static readonly DEFAULT_STYLE = 'Streets'
  private static readonly DEFAULT_STYLES = [
    { title: 'Streets', uri: STYLE.DEFAULT },
    { title: 'Satellite', uri: STYLE.SATELLITE },
    { title: 'Dark', uri: STYLE.DARK },
    { title: 'Light', uri: STYLE.GRAY },
    { title: 'Outdoors', uri: STYLE.OUTDOORS },
    { title: 'Navigation', uri: STYLE.NAVIGATION },
  ]
